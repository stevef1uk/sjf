...
func (o *GetAccountsParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetAccountsParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
